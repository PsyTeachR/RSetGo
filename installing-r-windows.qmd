...
Navigate to the [https://www.stats.bris.ac.uk/R/](https://www.stats.bris.ac.uk/R/){target="_blank"} site, it will take you to the download page for R (@fig-img-R-CRAN-1).
...
Now you have R installed, you can now download RStudio as the IDE you will interact with. Under [RStudio IDE](https://docs.posit.co/ide/user/?_gl=1*cb6q7c*_gcl_au*MTkwNzk3MjYwNC4xNzg5NDc4ODEx*_ga*MTQwNTM4Mzg4NC4xNzg2NDM5Nzcw*_ga_G020NYQMP9*czE3ODk0Nzg4MDckbzEkZzEkdDE3ODk0ODIzMjUkajE2JGwwJGgw#rstudio-ide-oss-downloads){target="_blank"}, select the Download option for your version of Windows. Make sure you select the RStudio IDE option under Direct Downloads (Open Source) and **not** Direct Downloads (Commerical). 

Clicking this link will start downloading the file to your downloads folder. Once it has finished downloading, double click on the file to start the installation process.
